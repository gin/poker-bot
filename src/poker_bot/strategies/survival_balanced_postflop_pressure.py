"""Balanced survival strategy with controlled postflop pressure.

This starts from survival_balanced, then adds two conservative postflop layers:
small dry-board probes when checking gives up too much initiative, and cheap
defense against larger-stack pressure with medium hands or real draws.
"""
