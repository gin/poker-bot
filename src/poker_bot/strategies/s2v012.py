...
Improved opponent profiling
Improved SPR

note: worse performance with simpler 6 players
Detect barrel
Targeted patch barrel

Targeted patch set-mining for paired board

start: 2026-06-19, morning
end: 2026-06-19, 4:10pm
"""
...
def _is_tag_profile(profile):
    ...
    return vpip <= 0.20 and pfr >= 0.10 and pfr / max(vpip, 0.01) >= 0.60
