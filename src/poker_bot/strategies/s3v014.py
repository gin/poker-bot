...
Optimize for heads up (1 opponent table)
    ...
    Opponent                   s3base  s3v013  Delta  Gate
    ─────────────────────────  ──────  ──────  ─────  ───────
 ...
 Arena results summary (telemetry-luigi-playground.sqlite):
  ...
  s3v014 (all guards, tuned): pending arena deployment

 Key findings:
  - Min-raise wars are the #1 leak in arena play (s3v005: -2,437 from 2 hands)
  - Postflop air double-barreling is the #2 leak (s3v012: -251 from 4 hands)
  - Both are addressed by new guards in s3v014
"""
