"""
Flattened v001 — Single-file strategy.
...
def sixmax_adjustment(table, my_seat, base) -> ActionDecision | None:
    # TODO: add small table size guard for specific strategies
    # if seated_players(table) < 4:
    #     return None
    for adjustment in (
        ...
        weak_pair_wet_board_pot_control,  # from v004
        strong_top_pair_defense,  # from v005
        mixed_threshold_pressure_response,  # from v004
