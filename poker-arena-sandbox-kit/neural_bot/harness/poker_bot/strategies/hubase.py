...
PREFLOP_LOOSE_CALL_MIN_SCORE = 38
PREFLOP_LOOSE_CALL_SCORE_THRESHOLD = 50
PREFLOP_LOOSE_CALL_MAX_PRICE_IP = 0.28
PREFLOP_LOOSE_CALL_MAX_PRICE_BB = 0.25
PREFLOP_LOOSE_CALL_MAX_PRICE_OOP = 0.20
PREFLOP_LOOSE_CALL_MAX_OPPONENTS = 3
PREFLOP_DEFENSE_MIN_SCORE = 50
PREFLOP_DEFENSE_MAX_PRICE = {
    "BB": 0.40,
    "SB": 0.24,
}
PREFLOP_DEFENSE_MAX_STACK_FRACTION = 0.12
...
SET_MINING_MAX_PRICE = 0.118
SET_MINING_TIGHT_OPPONENT_VPIP = 0.18
SET_MINING_MIN_SPR = 8.0
SMALL_PAIR_MULTIWAY_MIN_PLAYERS = 3
SMALL_PAIR_MULTIWAY_MAX_PRICE = 0.05
MEDIUM_HAND_MULTIWAY_MIN_PLAYERS = 3
MEDIUM_HAND_MULTIWAY_MAX_PRICE = 0.20
...
def board_assisted_two_pair_guard(table, my_seat, blueprint) -> ActionDecision | None:
    ...
    if hand_rank[0] != 2:
        return None
    pair_high_rank = hand_rank[1]
    pair_low_rank = hand_rank[2]
...
def preflop_positional_defense(table, my_seat, base) -> ActionDecision | None:
    ...
    min_score, max_price = thresholds.get(pos, (65, 0.20))
...
def sixmax_adjustment(table, my_seat, base) -> ActionDecision | None:
    ...
    for adjustment in (
        ...
        medium_pair_paired_board_fold_guard,
        two_pair_paired_board_overfold_guard,
        paired_board_pot_control,
        rank_two_facing_bet_guard,
        board_dominated_trips_guard,
        board_assisted_two_pair_guard,
        river_two_pair_raise_guard,
        preflop_premium_3bet_shove,
        preflop_min_raise_war_cap,
        postflop_marginal_hand_war_cap,
        postflop_air_double_barrel_guard,
        river_one_pair_over_call,
        paired_board_range_fold,
        medium_hand_multiway_fold_guard,
        weak_pair_wet_board_pot_control,
        strong_top_pair_defense,
        high_card_bottom_pair_check,
