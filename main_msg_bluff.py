...
def action_request_body(_competition_id, table_id, action, amount=None):
    body = {
        ...
        "action": action,
        #"message": message or "",
        ## Random message to chat
        #"message": public_action_message(),
        "message": '{vr: "0.30", ke: "72o", pp: "unopened", sr: "fold"}',
    }
    ...
    while True:
        try:
            ...
            for table in tables:
                ...
                ## Live call without message
                body = action_request_body(competition_id, table_id, action, amount)
                #body = action_request_body(competition_id, table_id, action, amount, message)
